...
const std::map<char, String> huffmanCodes = {
  {'"', "110"}, {'a', "000"},  {' ', "0111"},  {',', "0010"},  {'e', "1111"},  {'r', "0100"},  {'t', "1010"},  {':', "10111"},  {'_', "10000"},  {'d', "01011"},
  {'i', "10001"},  {'m', "10010"},  {'n', "01100"},  {'o', "00110"},  {'u', "01101"},  {'0', "001111"},  {'2', "010100"},  {'h', "010101"},  {'p', "111011"},
  {'s', "100110"},  {'1', "1001110"},  {'3', "1001111"},  {'7', "1011010"},  {'c', "1110011"},  {'x', "1110101"},  {'{', "0011100"},  {'}', "0011101"},
  {'4', "10110000"},  {'5', "10110001"},  {'6', "10110010"},  {'9', "10110011"},  {'A', "10110110"},  {'E', "10110111"},  {'F', "11100000"},
  {'L', "11100001"},  {'R', "11100010"},  {'T', "11100011"},  {'b', "11100100"},  {'g', "11100101"},  {'l', "11101000"},  {'v', "11101001"}
};
